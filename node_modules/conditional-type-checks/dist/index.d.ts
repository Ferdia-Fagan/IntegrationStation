 ...
 */
export declare type IsExact<T, U> = TupleMatches<AnyToBrand<T>, AnyToBrand<U>> extends true ? TupleMatches<DeepMakeRequiredForIsExact<T>, DeepMakeRequiredForIsExact<U>> extends true ? true : false : false;
declare type DeepMakeRequiredForIsExact<T> = {
...
declare type TupleMatches<T, U> = Matches<[T], [U]> extends true ? true : false;
declare type Matches<T, U> = T extends U ? U extends T ? true : false : false;
declare type AnyToBrand<T> = IsAny<T> extends true ? {
